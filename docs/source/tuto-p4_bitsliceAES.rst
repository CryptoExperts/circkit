...
In this example, we build a circuit of bit-slicing AES. This
implementation is based on the white-box AES of
`BU18 <https://github.com/cryptolu/whitebox/blob/master/synthesis/whitebox/ciphers/AES/bitaes.py>`__.
...
For a white-box implementation, we can treat the key as 128 constants of
bits instead of 128 input nodes.
